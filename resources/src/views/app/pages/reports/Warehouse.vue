...
export default {
  ...
  methods: {
    ...
    //------------------------------ Show Reports -------------------------\\
    Get_Reports() {
      axios.get('report/warehouse_report', {
        params: {
    ...
    Get_Sales(page) {
      axios.get("report/sales_warehouse", {
        params: {
          page: page,
          limit: this.limit_sales,
          warehouse_id: this.Filter_warehouse,
          search: this.search_sale
        }
      }).then(response => {
    ...
    Get_Quotations(page) {
      axios.get("report/quotations_warehouse", {
        params: {
          page: page,
          limit: this.limit_quotations,
          warehouse_id: this.Filter_warehouse,
          search: this.search_quotation
        }
      }).then(response => {
    ...
    Get_Returns_Sale(page) {
      axios.get("report/returns_sale_warehouse", {
        params: {
          page: page,
          limit: this.limit_returns_Sale,
          warehouse_id: this.Filter_warehouse,
          search: this.search_return_Sale
        }
      }).then(response => {
    ...
    Get_Returns_Purchase(page) {
      axios.get("report/returns_purchase_warehouse", {
        params: {
          page: page,
          limit: this.limit_returns_Purchase,
          warehouse_id: this.Filter_warehouse,
          search: this.search_return_Purchase
        }
      }).then(response => {
    ...
    Get_Expenses(page) {
      axios.get("report/expenses_warehouse", {
        params: {
          page: page,
          limit: this.limit_expenses,
          warehouse_id: this.Filter_warehouse,
          search: this.search_expense
        }
      }).then(response => {
    ...
    report_with_echart() {
      axios.get('report/warhouse_count_stock').then(response => {
