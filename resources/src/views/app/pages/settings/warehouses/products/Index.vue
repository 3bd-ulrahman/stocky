    ...
    <div v-else>
      ...
      >
        <div slot="selected-row-actions">
          <button class="btn btn-danger" @click="destroyProduct()">{{$t('Del')}}</button>
        </div>
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            ...
            <a
              ...
              @click="destroyProduct(props.row.id)"
              v-b-tooltip.hover
              title="Delete"
...
export default {
  ...
  methods: {
    ...
    Get_Products(page) {
      ...
      axios.get(`warehouses/${this.$route.params.warehouse}/products`, {
        params: {
          page: page,
